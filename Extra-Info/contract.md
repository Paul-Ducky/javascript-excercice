...
- Any absence or delay (or early departure) must be:
	1. announced via the interface [my.becode.org](https://my.becode.org/)
...
If you already have a discord account with a given name, you can ask the coaches to give you a nickname in the BeCode servers.